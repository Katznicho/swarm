...
function App() {
  ...
  return (
    <div className="App">
        ...
        <div className="container">
          ...
          <div className="contact-content">
            <div className="contact-info">
              <div className="contact-item">
                ...
                <div className="contact-details">
                  ...
                  <p>
                    ...
                    <span style={{ display: 'block', fontSize: '0.85rem', color: 'var(--text-light)', marginTop: '0.25rem' }}>
                      Hoima Manager
                    </span>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <span style={{ display: 'block', fontSize: '0.85rem', color: 'var(--text-light)', marginTop: '0.25rem' }}>
                      Central Uganda Regional Manager
                    </span>
                  </p>
                </div>
              </div>
              <div className="contact-item">
                ...
                <div className="contact-details">
                  <h4>WhatsApp</h4>
                  <p>
                    <a href="https://wa.me/256771213423?text=Hello%20Swarm%20Matrix%20Business%20Hub" target="_blank" rel="noopener noreferrer">
                      +256 771 213 423
                    </a>
                  </p>
                </div>
              ...
              <div className="contact-item">
                ...
                <div className="contact-details">
                  <h4>Email</h4>
                  <p>
                    <a href="mailto:swarmbh23@gmail.com" target="_blank" rel="noopener noreferrer">swarmbh23@gmail.com</a>
                  </p>
                </div>
              </div>
              <div className="contact-item">
                ...
                <div className="contact-details">
                  <h4>Location</h4>
                  <p>C8QX+77F, Butiaba Rd</p>
                  <p>Hoima City, Uganda</p>
                  <p style={{ marginTop: '0.5rem' }}>
                    <a 
                      href="https://maps.app.goo.gl/pZVoRiunJKKo29L37" 
                      target="_blank" 
            ...
            <div className="map-container">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.5!2d31.3522!3d1.4317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMcKwMjUnNTQuMSJOIDMxwrAyMScwNy45IkU!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus"
                width="100%"
                height="100%"
                ...
                title="Swarm Matrix Business Hub Location"
              ></iframe>
            </div>
          </div>
        </div>
      ...
      <a
        href="https://wa.me/256771213423?text=Hello%20Swarm%20Matrix%20Business%20Hub"
